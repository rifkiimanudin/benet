        ...
        <div class="col-lg-12 padding-250 text-right text-gray-900">
            <form action="<?= base_url('pembayaran/bayar') ?>" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="nama" name="email" value="<?= $pelanggan['nama']; ?>" readonly>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <a href="<?= base_url('pemesanan/pendaftaran') ?>" class="btn btn-danger">Kembali</a>
